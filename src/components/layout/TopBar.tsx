  ...
  return (
    <header className="sticky top-0 z-40 bg-[#FFFFFF]/95 dark:bg-[#191C20]/95 backdrop-blur-md border-b border-[#121212]/10 dark:border-[#33363A] px-4 lg:px-6 py-2.5 transition-colors">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        {/* Brand */}
        <div className="flex items-center gap-2 sm:gap-3 cursor-pointer shrink-0" onClick={() => setActiveTab(AppTab.DASHBOARD)}>
          <ProcureLogo size="md" />
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              <span className="font-serif text-sm sm:text-base md:text-lg font-bold tracking-tight text-[#121212] dark:text-[#E2E2E6] truncate max-w-[130px] xs:max-w-[170px] sm:max-w-none">
                Smart Procurement
              </span>
              <span className="text-[9px] sm:text-[10px] font-mono font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-[#F4F0E8] dark:bg-slate-800 text-[#121212] dark:text-slate-200 border border-[#121212]/10 dark:border-slate-700 hidden xs:inline-block">
                Enterprise
              </span>
            </div>
            <p className="text-[10px] sm:text-[11px] text-slate-600 dark:text-slate-400 hidden sm:block">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2 sm:px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all ${
          ...
          <button
            ...
            className="flex items-center gap-1.5 sm:gap-2 bg-[#121212] text-white hover:bg-slate-800 dark:bg-amber-400 dark:text-[#121212] dark:hover:bg-amber-300 rounded-xl px-2 sm:px-3 py-1.5 text-xs font-bold shadow-xs transition-all active:scale-95"
            title="Open 7-Stage Interactive Walkthrough"
          >
            <Sparkles className="w-3.5 h-3.5 text-amber-400 dark:text-[#121212]" />
            <span className="hidden md:inline">7-Stage Interactive Walkthrough</span>
            <span className="hidden xs:inline md:hidden">Walkthrough</span>
